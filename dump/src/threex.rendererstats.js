...
THREEx.RendererStats = function () {
	...
	msText.style.cssText = 'color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:24px';
	...
	for (var i = 0; i < nLines; i++) {
		...
		msTexts[i].style.cssText = 'color:#fff;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:24px';
