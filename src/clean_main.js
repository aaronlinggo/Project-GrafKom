...
function showFPS() {
    ...
    script.src = "./dump/src/stats.min.js";
...
// let planeGeometry = new THREE.PlaneGeometry(100, 100, 25, 25);
...
// const redColorSample = Math.floor(216/54);
// const greenColorSample =  Math.floor(184/54);
// const blueColorSample =  Math.floor(140/54);
...
//     "./textures/Dirt_006_SD/Dirt_006_Base Color.jpg",
//     (texture) => {
//         texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
...
//     "./textures/Dirt_006_SD/Dirt_006_Ambient Occlusion.jpg",
//     (texture) => {
//         texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
//         texture.offset.set(0, 0);
//         texture.repeat.set(20, 20);
...
//     "./textures/Dirt_006_SD/Dirt_006_Height.png",
//     (texture) => {
//         texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
//         texture.offset.set(0, 0);
//         texture.repeat.set(20, 20);
...
//     "./textures/Dirt_006_SD/Dirt_006_Normal.jpg",
//     (texture) => {
//         texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
//         texture.offset.set(0, 0);
//         texture.repeat.set(20, 20);
...
//     "./textures/Dirt_006_SD/Dirt_006_Roughness.jpg",
//     (texture) => {
//         texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
//         texture.offset.set(0, 0);
//         texture.repeat.set(20, 20);
...
let fpsControls = new THREE.PointerLockControls(camera, renderer.domElement);
...
objectLoader.load("./models/old_japanese_lantern/scene_low.gltf",
    (gltf) => {
...
function animate() {
    ...
    // if (ctrTimeDay%12 == 0){
    //     if (ctrDay == 0){
    //         color_red_fog -= redColorSample;
    //         color_green_fog -= greenColorSample;
    //         color_blue_fog -= blueColorSample;
    //     }
    //     else{
    //         color_red_fog += redColorSample;
    //         color_green_fog += greenColorSample;
...
objectLoader.load(
    "./models/japanese_lowpoly_temple/scene_low.gltf",
    (gltf) => {
        gltf.scene.traverse((child) => {
            if (child.isMesh) {
                child.castShadow = true;
...
function drawStoneWall() {
    if (
        ...
        // Outer most front: -1.5
        // Next one: -4
        // Next two: -8.7
        // Inner most rear: -11.2
        ...
        wallPositionA.push([-16.45, clippedHeightWallA,  26.7]);
        wallPositionA.push([-11.75, clippedHeightWallA,  26.7]);
        wallPositionA.push([- 7.05, clippedHeightWallA,  26.7]);
        wallPositionA.push([- 2.35, clippedHeightWallA,  26.7]);
        wallPositionA.push([  2.35, clippedHeightWallA,  26.7]);
        wallPositionA.push([  7.05, clippedHeightWallA,  26.7]);
        wallPositionA.push([ 11.75, clippedHeightWallA,  26.7]);
        wallPositionA.push([ 16.45, clippedHeightWallA,  26.7]);

        wallPositionA.push([-16.45, clippedHeightWallA, - 1.5]);
        wallPositionA.push([-11.75, clippedHeightWallA, - 1.5]);
        wallPositionA.push([- 7.05, clippedHeightWallA, - 1.5]);
        wallPositionA.push([- 2.35, clippedHeightWallA, - 1.5]);
        wallPositionA.push([  2.35, clippedHeightWallA, - 1.5]);
        wallPositionA.push([  7.05, clippedHeightWallA, - 1.5]);
        wallPositionA.push([ 11.75, clippedHeightWallA, - 1.5]);
        wallPositionA.push([ 16.45, clippedHeightWallA, - 1.5]);
        ...
        // 11.2
        wallPositionA.push([-16.45, clippedHeightWallA, - 8.2]);
        wallPositionA.push([-11.75, clippedHeightWallA, - 8.2]);
        wallPositionA.push([- 7.05, clippedHeightWallA, - 8.2]);
        wallPositionA.push([- 2.35, clippedHeightWallA, - 8.2]);
        wallPositionA.push([  2.35, clippedHeightWallA, - 8.2]);
        wallPositionA.push([  7.05, clippedHeightWallA, - 8.2]);
        wallPositionA.push([ 11.75, clippedHeightWallA, - 8.2]);
        wallPositionA.push([ 16.45, clippedHeightWallA, - 8.2]);

        wallPositionA.push([-16.45, clippedHeightWallA, -12.9]);
        wallPositionA.push([-16.45, clippedHeightWallA, -17.6]);
        wallPositionA.push([-16.45, clippedHeightWallA, -22.3]);
        wallPositionA.push([-16.45, clippedHeightWallA, -27]);
        wallPositionA.push([-16.45, clippedHeightWallA, -31.7]);
        
        wallPositionA.push([-16.45, clippedHeightWallA, -36.4]);
        wallPositionA.push([-11.75, clippedHeightWallA, -36.4]);
        wallPositionA.push([- 7.05, clippedHeightWallA, -36.4]);
        wallPositionA.push([- 2.35, clippedHeightWallA, -36.4]);
        wallPositionA.push([  2.35, clippedHeightWallA, -36.4]);
        wallPositionA.push([  7.05, clippedHeightWallA, -36.4]);
        wallPositionA.push([ 11.75, clippedHeightWallA, -36.4]);
        wallPositionA.push([ 16.45, clippedHeightWallA, -36.4]);
        ...
        // Front Row
        // wallPositionA.push([-16.35, clippedHeightWallA, 26.7]);
        // wallPositionA.push([-11.65, clippedHeightWallA, 26.7]);
        // wallPositionA.push([-6.95, clippedHeightWallA, 26.7]);

        // // wallPositionA.push([-2.25, clippedHeightWallA, 26.7]);
        // // wallPositionA.push([2.455, clippedHeightWallA, 26.7]);
        // wallPositionA.push([-2.35, clippedHeightWallA, 26.7]);
        // wallPositionA.push([ 2.35, clippedHeightWallA, 26.7]);

        // wallPositionA.push([7.155, clippedHeightWallA, 26.7]);
        // wallPositionA.push([11.855, clippedHeightWallA, 26.7]);
        // wallPositionA.push([16.555, clippedHeightWallA, 26.7]);
        // wallPositionA.push([16.555, clippedHeightWallA, 22.0]);
        // wallPositionA.push([16.555, clippedHeightWallA, 17.3]);
        // wallPositionA.push([16.555, clippedHeightWallA, 12.6]);
        // wallPositionA.push([16.555, clippedHeightWallA, 7.9]);
        // wallPositionA.push([16.555, clippedHeightWallA, 3.2]);
        // wallPositionA.push([-16.35, clippedHeightWallA, -1.5]);
        // wallPositionA.push([-11.65, clippedHeightWallA, -1.5]);
        // wallPositionA.push([-6.95, clippedHeightWallA, -1.5]);
        // wallPositionA.push([-2.25, clippedHeightWallA, -1.5]);
        // wallPositionA.push([2.455, clippedHeightWallA, -1.5]);
        // wallPositionA.push([7.155, clippedHeightWallA, -1.5]);
        // wallPositionA.push([11.855, clippedHeightWallA, -1.5]);
        // wallPositionA.push([16.555, clippedHeightWallA, -1.5]);
        // wallPositionA.push([-16.35, clippedHeightWallA, 22.0]);
        // wallPositionA.push([-16.35, clippedHeightWallA, 17.3]);
        // wallPositionA.push([-16.35, clippedHeightWallA, 12.6]);
        // wallPositionA.push([-16.35, clippedHeightWallA, 7.9]);
        // wallPositionA.push([-16.35, clippedHeightWallA, 3.2]);
        ...
        // Shitennoji
        // Front Row
        // wallPositionA.push([-16.35, clippedHeightWallA, -22.7]);
        // wallPositionA.push([-11.65, clippedHeightWallA, -22.7]);
        // wallPositionA.push([-6.95, clippedHeightWallA,  -22.7]);
        // wallPositionA.push([-2.25, clippedHeightWallA,  -22.7]);
        // wallPositionA.push([2.455, clippedHeightWallA,  -22.7]);
        // wallPositionA.push([7.155, clippedHeightWallA,  -22.7]);
        // wallPositionA.push([11.855, clippedHeightWallA, -22.7]);
        // wallPositionA.push([16.555, clippedHeightWallA, -22.7]);
        // wallPositionA.push([16.555, clippedHeightWallA, -18.0]);
        // wallPositionA.push([16.555, clippedHeightWallA, -13.3]);
        // wallPositionA.push([16.555, clippedHeightWallA, - 8.6]);
        // wallPositionA.push([16.555, clippedHeightWallA, - 3.9]);
        // wallPositionA.push([16.555, clippedHeightWallA, - 1.2]);
        // wallPositionA.push([-16.35, clippedHeightWallA, -10.5]);
        // wallPositionA.push([-11.65, clippedHeightWallA, -10.5]);
        // wallPositionA.push([-6.95, clippedHeightWallA,  -10.5]);

        // wallPositionA.push([-2.35, clippedHeightWallA,  -10.5]);
        // wallPositionA.push([ 2.35, clippedHeightWallA,  -10.5]);

        // wallPositionA.push([7.155, clippedHeightWallA,  -10.5]);
        // wallPositionA.push([11.855, clippedHeightWallA, -10.5]);
        // wallPositionA.push([16.555, clippedHeightWallA, -10.5]);
        // wallPositionA.push([-16.35, clippedHeightWallA, -18.0]);
        // wallPositionA.push([-16.35, clippedHeightWallA, -13.3]);
        // wallPositionA.push([-16.35, clippedHeightWallA, - 8.6]);
        // wallPositionA.push([-16.35, clippedHeightWallA, - 3.9]);
        // wallPositionA.push([-16.35, clippedHeightWallA, - 1.2]);
